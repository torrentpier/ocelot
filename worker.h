...
class worker {
	...
	public:
		...
		std::string announce(const std::string &input, torrent &tor, user_ptr &u, params_type &params, params_type &headers, std::string &ip, client_opts_t &client_opts, std::string info_hash);
